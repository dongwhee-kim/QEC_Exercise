...
- **Bell State Measurement (BSM)**: One of the most representative examples. It identifies which of the four perfect entangled states two qubits share, acting as the core engine for quantum teleportation. All quantum gates are **reversible**. **We can know the input based on output**.
