...
## $\color{red}{\text{Bottleneck! : Distillation Throughput < T-gate Consumption ➔ System Stall}}$
## $\color{red}{\text{Understand Space-time trade-off, Understand Magic State Factory Count}}$
